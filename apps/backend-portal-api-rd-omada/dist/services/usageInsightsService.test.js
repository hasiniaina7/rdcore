...
(0, vitest_1.describe)('usageInsightsService', () => {
    ...
    (0, vitest_1.it)('aggregates sessions across default periods', async () => {
        ...
        (0, vitest_1.expect)(mockedGetSessions).toHaveBeenCalledWith('demo@example.com', 100, { onlyConnected: false });
    ...
    (0, vitest_1.it)('builds timeseries with selected granularity', async () => {
        ...
        (0, vitest_1.expect)(mockedGetSessions).toHaveBeenCalledWith('demo@example.com', 120, { onlyConnected: false });
