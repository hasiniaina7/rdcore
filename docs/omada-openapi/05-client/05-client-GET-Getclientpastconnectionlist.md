# Client Insight – Get client past connection list
...
- **Description** : Get client past connection list.
...
- **HTTP Status** : 200
  ...
  - **Content-Type** : */*
  - **Schema** : `#/components/schemas/OperationResponseGridVOClient History Info`
