# Voucher – Get unused vouchers in selected voucher groups
...
- **Description** : Get unused vouchers brief information in selected voucher groups.
...
## Exemple de requête
```
POST /openapi/v1/{omadacId}/sites/{siteId}/hotspot/voucher-groups/batch/print-unused
Headers: ...
Body:
{}
```)
