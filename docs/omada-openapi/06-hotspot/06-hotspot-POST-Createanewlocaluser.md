# Local User – Create a new local user
...
- **Description** : Create a local user with the given params.
...
- **Body (schema)** :
  ...
  - Champs :
    ...
    | userName | string | yes | User name should contain 1 to 128 ASCII visible characters, with no spaces at the beginning and end, and spaces in the middle, cannot be changed after creation. |
...
## Exemple de requête
```
POST /openapi/v1/{omadacId}/sites/{siteId}/hotspot/localusers
Headers: ...
Body:
{}
```)
